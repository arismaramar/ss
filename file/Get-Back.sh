...
# //  telegram: https://t.me/anggun2
# //====================================================
# // font color configuration | ANGGN AIO
clear
...
function BACKUPVPS() {
    ...
    zip -r FT-${DATEVPS}.zip backup >/dev/null 2>&1
...
© Copyright By https://github.com/comot
Report bugs   : https://t.me/anggun2
FighterTunnel Project
    " | mail -s "anggun Backup" $EMAIL
    clear
